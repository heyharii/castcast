      ...
      <div class="container">
        ...
        <div class="topbar-right">
          <ul class="topbar-nav nav">
            ...
            @auth
                @admin 
                  <li class="nav-item"><a href="{{ route('series.index') }}" class="nav-link">Admin series</a></li>
                ...
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('profile', auth()->user()->username) }}">My Profile</a></li>
                </li>
          ...
          <div class="col-12 col-lg-6">
            <ul class="nav nav-primary nav-hero">
              <li class="nav-item hidden-sm-down">
                <a class="nav-link" href="/">Castcasts</a>
              </li>
            </ul>
          </div>
        </div>
